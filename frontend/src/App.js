...
import SeePhoto from "./components/SeePhoto";
import AddComment from "./components/AddComment";
import Tagged from "./components/Tagged.js";
      ...
      <UserContext.Provider value={{
        ...
        <div className="App">
          ...
          <Routes>
            ...
            <Route path="/popular" exact element={<Popular />}></Route>
            ...
            <Route path="/photos/tag/:name" element={<Tagged />}></Route>
            <Route path="/photos/:id" exact element={<SeePhoto />}></Route>
            <Route path="/photos/upvote/:id" element={<AddComment />}></Route>
            <Route path="/photos/downvote/:id" element={<AddComment />}></Route>
